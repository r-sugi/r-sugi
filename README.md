...
- [学歴・職歴](#学歴・職歴)
  - [業務委託案件](#業務委託案件)
  - [業務委託案件より前(大学~正社員エンジニア)](#業務委託案件より前大学正社員エンジニア)
  - [個人受託開発](#個人受託開発)
- [資格](#資格)
...
## ポートフォリオ
Lapras: https://lapras.com/public/2T6JFI5

## 各種アカウント
<p>
  <a href="https://github.com/r-sugi" target="_blank"><img alt="Github" src="https://img.shields.io/badge/r--sugi-%2312100E.svg?&amp;style=flat-square&amp;logo=Github&amp;logoColor=white"></a>
  <a href="https://zenn.dev/rsugi" target="_blank"><img alt="Zenn" src="https://img.shields.io/badge/rsugi-3EA8FF.svg?&amp;style=flat-square&amp;logo=Zenn&amp;logoColor=white"></a>
  <a href="https://twitter.com/rsugi8" target="_blank"><img alt="Twitter" src="https://img.shields.io/badge/@rsugi8-%231DA1F2.svg?&amp;style=flat-square&amp;logo=twitter&amp;logoColor=white"></a>
</p>
...
- 好奇心旺盛で技術のキャッチアップが早い
- 問題を解決しようとする行動力
  - 例: ライブラリの挙動調査と質問 (node-redis)[https://github.com/redis/node-redis/issues/2564]
...
<p>
  <img alt="Nest.js" src="https://img.shields.io/badge/-Nest-E10098?style=flat-square&amp;logo=NestJS&amp;logoColor=white">
</p>
...
- コードの品質を意識していること
  ...
  - エラー処理を意識した堅牢性の高いコード
  - 課題を認識して、計画的に解消のために取り組んでいること
- 静的型付け言語(例: Go, Kotlin, Typescript)で開発していること

Want
- 大規模プロダクト(例: 月間MAU100万人以上、大量データ量を扱う)
- 英語でコミュニケーション
...
| 年月 | 学歴・職歴 | 備考 |
|:---|:---|:---|
|2022年4月 – 2023年8月(16ヶ月) | 無人系美容サロンの予約サイト開発 | PM・開発<br>依頼主との商談、要件定義以降の全ての工程を担当<br>Ruby on Railsで開発済。運用中 |
|2023年4月 – 2023年8月(4ヶ月) | Youtubeアニメ動画のまとめ静的サイトの開発 | PM・開発<br>依頼主との商談、要件定義以降の全ての工程を一人で担当<br>Next.jsで開発済。運用中<br>サイト https://neetgokudo.com/ |
|2021年6月 – 2022年1月(8ヶ月) | toB向けレンタルサーバーの管理サイト開発(PoC) | PM・開発<br>依頼主の要件定義に基づいて、PoC開発を一人で担当<br>Vue.js + cloud functionsで開発済。収益が伸びなかったため閉鎖済み。 |
